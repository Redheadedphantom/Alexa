...
__all__ = [
    'SREStateChange', 'DISPID_SVSInputSentencePosition',
    'SRTEmulated', 'DISPIDSPTSI_ActiveLength', 'SPSMF_UPS', 'SPSLMA',
    'DISPID_SOTCategory', 'DISPID_SVGetVoices', 'SGRSTTRule',
    'ISpeechWaveFormatEx', 'SLTApp', 'SGRSTTWord',
    'DISPID_SVDisplayUI', 'SGLexicalNoSpecialChars',
    'ISpeechGrammarRules', 'ISpeechLexiconWord',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SLGetGenerationChange',
    'ISpProperties', 'SP_VISEME_18', 'SVP_4', 'ISpRecoContext',
    'DISPID_SOTCGetDataKey', 'SVF_Emphasis',
    'DISPID_SRCRetainedAudio', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SRRRecoContext', 'SPWORDLIST', 'SP_VISEME_6',
    'SAFTGSM610_22kHzMono', 'eLEXTYPE_PRIVATE5', 'SPLEXICONTYPE',
    ...
    'STSF_FlagCreate', 'DISPID_SVResume',
    'SpeechRecoProfileProperties', 'DISPID_SCSBaseStream',
    'IEnumString', 'DISPID_SPEAudioStreamOffset', 'SPEI_SOUND_END',
    'SVP_13', 'DISPID_SVWaitUntilDone', 'SAFTCCITT_uLaw_22kHzStereo',
    'SASRun', 'SpeechVoicePriority', 'SPSMF_SAPI_PROPERTIES',
    'ISpRecognizer2', 'DISPID_SPRulesItem', 'SRESoundStart',
    'DISPID_SPPConfidence', 'SpSharedRecoContext', 'SPSModifier',
    'DISPID_SADefaultFormat', 'SAFTCCITT_ALaw_8kHzMono',
    'SpMMAudioEnum', 'DISPID_SOTs_NewEnum', 'SPEI_RESERVED2',
    'DISPID_SLPPhoneIds', 'SpeechWordPronounceable',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SLGetWords',
    'DISPID_SPIElements', 'DISPID_SVSkip', 'SpeechTokenIdUserLexicon',
    'ISpeechDataKey', 'ISpNotifyTranslator',
    'DISPID_SASCurrentDevicePosition', 'SVSFParseSsml', 'SPXRO_SML',
    'SAFT44kHz8BitStereo', 'SPEI_RESERVED1', 'eLEXTYPE_RESERVED7',
    'SPBO_TIME_UNITS', 'SDTAll', 'DISPID_SPILanguageId',
    'DISPID_SRGDictationSetState', 'DISPID_SVSLastStreamNumberQueued',
    'SRERecoOtherContext', 'DISPID_SPEsItem', 'DISPID_SVEStreamEnd',
    'SSSPTRelativeToEnd', 'DISPID_SPIAudioStreamPosition',
    'ISpeechPhraseProperty', 'SPRECOSTATE', 'SPWORDPRONUNCIATIONLIST',
    'SDTRule', 'SVP_18', 'SpInProcRecoContext',
    ...
    '_ISpeechRecoContextEvents', 'SDKLDefaultLocation',
    'SGRSTTWildcard', 'DISPID_SRCERequestUI', 'SVP_21',
    'SGRSTTDictation', 'DISPID_SRCEPropertyStringChange', 'SBONone',
    'SpObjectTokenCategory', 'DISPID_SpeechRecoResult',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SAFTCCITT_ALaw_22kHzStereo', 'WAVEFORMATEX', 'SPAUDIOSTATE',
    'DISPID_SRCState', 'DISPID_SpeechRecoContext',
    'SpeechRecognitionType', 'DISPID_SpeechPhraseInfo',
    'SpeechStreamSeekPositionType', 'DISPID_SVESentenceBoundary',
    'SASClosed', 'DISPID_SWFEFormatTag', 'DISPID_SDKEnumValues',
    'SPPROPERTYINFO', 'DISPID_SpeechGrammarRules', 'SP_VISEME_19',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SpeechRecognizer',
    'SPSEMANTICERRORINFO', 'SPDKL_CurrentUser',
    'ISpeechGrammarRuleStateTransitions', 'ISpeechPhraseAlternate',
    'SDTAlternates', 'ISpeechLexiconWords', 'SpObjectToken',
    'DISPID_SRGCmdSetRuleState', 'SPDATAKEYLOCATION',
    'ISpRecoGrammar', 'DISPID_SGRsDynamic', 'SpCompressedLexicon',
    'SAFTADPCM_8kHzMono', 'ISpeechAudioFormat', 'SAFT11kHz8BitStereo',
    'SAFTADPCM_22kHzStereo', 'DISPID_SGRsAdd', 'SP_VISEME_5',
    'SpeechVisemeType', 'SpSharedRecognizer', 'STSF_AppData',
    'DISPID_SpeechPhraseElement', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SpeechTokenValueCLSID', 'SP_VISEME_3', 'DISPID_SPPName',
    'DISPID_SVEBookmark', 'SpeechPartOfSpeech', 'SpeechInterference',
    'DISPID_SRGRules', 'SpMMAudioIn', 'SPRST_INACTIVE',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SPEActualConfidence',
    'SPEI_RESERVED5', 'ISpeechPhraseInfo', 'ISpeechAudioStatus',
    'SpPhoneConverter', 'ISpDataKey', 'SPSInterjection',
    'DISPID_SRGSetTextSelection', 'DISPID_SpeechPhraseRule',
    'SPPS_LMA', 'DISPID_SLWs_NewEnum', 'DISPID_SOTSetId',
    'ISpeechPhraseReplacements', 'SP_VISEME_13',
    'DISPID_SWFEExtraData', 'SAFT11kHz8BitMono', 'SFTSREngine',
    'ISequentialStream', 'DISPID_SOTsCount', 'SPFM_CREATE_ALWAYS',
    'ISpeechRecoResult2', 'SPEI_INTERFERENCE', 'DISPID_SPRuleParent',
    'DISPID_SPAsItem', 'SGPronounciation', 'SpStreamFormatConverter',
    'SPSHT_NotOverriden', 'SPPHRASEREPLACEMENT', 'DISPID_SVEViseme',
    'DISPID_SDKDeleteKey', 'SAFTText', 'SRSEDone', 'ISpLexicon',
    'DISPID_SGRsCommit', 'DISPID_SPIReplacements',
    'DISPID_SRDisplayUI', 'DISPID_SMSSetData', 'eLEXTYPE_PRIVATE7',
    'DISPID_SPIAudioSizeBytes', 'eLEXTYPE_PRIVATE15',
    'SpeechAudioFormatGUIDWave', 'SGLexical', 'SECFIgnoreKanaType',
    'DISPID_SPIAudioSizeTime', 'DISPID_SPARecoResult',
    'SpeechDataKeyLocation', 'SPCATEGORYTYPE', 'SPWORDPRONOUNCEABLE',
    'DISPID_SPIGetDisplayAttributes', 'eLEXTYPE_PRIVATE1',
    'ISpeechPhraseAlternates', 'SVP_17',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SpeechAudio',
    'SPADAPTATIONRELEVANCE', 'eLEXTYPE_PRIVATE10',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SAFTCCITT_uLaw_8kHzMono', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SRGetRecognizers', 'SpeechVoiceCategoryTTSRate',
    'ISpeechRecoGrammar', 'SLODynamic', 'DISPID_SpeechVoiceStatus',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SPAS_CLOSED',
    'DISPID_SOTCDefault', 'DISPID_SRGCmdLoadFromFile',
    'ISpeechGrammarRuleStateTransition', 'SPPS_Modifier',
    'DISPID_SGRAddResource', 'ISpeechGrammarRule',
    'ISpeechRecoContext', 'SPEI_PHRASE_START', 'DISPID_SRCVoice',
    'IEnumSpObjectTokens', 'DISPID_SPAPhraseInfo',
    'DISPID_SGRSTransitions', 'DISPID_SVGetAudioInputs',
    'DISPID_SLPsItem', 'SECFEmulateResult', 'DISPID_SRCESoundEnd',
    'DISPID_SDKGetStringValue', 'DISPID_SPRsCount',
    'SpInprocRecognizer', 'tagSPPROPERTYINFO', 'DISPID_SGRId',
    'SPVOICESTATUS', 'ISpeechPhraseInfoBuilder', 'DISPID_SRCPause',
    'DISPID_SpeechMMSysAudio', 'SVPAlert',
    'DISPID_SGRSAddWordTransition', 'DISPID_SRGCommit',
    'ISpeechPhraseProperties', 'DISPID_SWFEAvgBytesPerSec',
    'SpeechFormatType', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SPRuleName', 'DISPID_SRRSaveToMemory',
    'SAFTGSM610_11kHzMono', 'SRSActiveAlways',
    'DISPID_SOTMatchesAttributes', 'eLEXTYPE_RESERVED8',
    'DISPID_SVEWord', 'DISPID_SVEPhoneme', 'DISPID_SPRs_NewEnum',
    'SDTPronunciation', 'eLEXTYPE_PRIVATE12', 'SPAR_Low',
    'DISPID_SLRemovePronunciation', 'SAFT8kHz16BitStereo',
    'DISPID_SDKCreateKey', 'DISPID_SLPSymbolic', 'SVSFIsFilename',
    'SPRST_ACTIVE_ALWAYS', 'SRSEIsSpeaking', 'eLEXTYPE_PRIVATE8',
    'SSFMOpenReadWrite', 'eLEXTYPE_RESERVED6', 'DISPID_SPCLangId',
    'SVSFIsNotXML', 'DISPID_SLWLangId', 'DISPID_SVAlertBoundary',
    'SPINTERFERENCE_TOOSLOW', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SRCEBookmark', 'SPPS_RESERVED4', 'SPAUDIOOPTIONS',
    ...
    'DISPID_SASNonBlockingIO', 'DISPID_SGRsCount', 'SpLexicon',
    'DISPID_SOTGetAttribute', 'SPSNoun', 'SpeechRetainedAudioOptions',
    'SPAS_RUN', 'SPWORDPRONUNCIATION', 'ISpMMSysAudio',
    'SPRECOCONTEXTSTATUS', 'SpeechRecoContextState', 'SVEAudioLevel',
    'DISPID_SpeechObjectTokenCategory', 'ISpPhrase',
    'SpeechCategoryAppLexicons', 'SVPOver',
    'DISPID_SPIEnginePrivateData', 'SVSFDefault', 'SpMemoryStream',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SVSLastResult',
    'SPPARTOFSPEECH', 'SREPrivate', 'ISpeechLexiconPronunciations',
    'SpeechVoiceSkipTypeSentence', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SPERetainedStreamOffset', 'ISpNotifySink',
    'SAFT48kHz16BitStereo', 'DISPID_SPPChildren',
    'SSSPTRelativeToStart', 'DISPID_SVGetAudioOutputs',
    'ISpeechRecoResultDispatch', 'IInternetSecurityMgrSite',
    'SPLO_DYNAMIC', 'ISpeechVoice', 'SAFTNoAssignedFormat',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SPIProperties',
    'SpeechStreamFileMode', 'ISpRecoContext2', 'SPGRAMMARWORDTYPE',
    'DISPID_SPAs_NewEnum', 'ISpStreamFormat', 'SpeechAudioVolume',
    'SDTProperty', 'SP_VISEME_4', 'SPAS_STOP', 'SPPS_NotOverriden',
    ...
    'ISpeechTextSelectionInformation', 'DISPID_SRCRequestedUIType',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SAFTCCITT_ALaw_44kHzStereo', 'SECLowConfidence', 'SGDSActive',
    'SPEI_PROPERTY_STRING_CHANGE', 'SAFT44kHz16BitStereo',
    'DISPID_SRGCmdLoadFromObject', 'SREBookmark',
    'DISPID_SVSPhonemeId', 'DISPID_SPPNumberOfElements',
    'DISPID_SRCEAudioLevel', 'SREPropertyStringChange',
    'ISpeechAudio', 'ISpPhoneticAlphabetSelection', 'DISPID_SPRsItem',
    'SPVPRI_ALERT', 'DISPID_SPRuleNumberOfElements',
    'SpeechPropertyAdaptationOn', 'ISpeechCustomStream',
    'SPEVENTSOURCEINFO', 'DISPID_SRCVoicePurgeEvent',
    'SPINTERFERENCE_NOSIGNAL', 'SAFT24kHz8BitMono',
    'DISPID_SWFEChannels', 'SPLO_STATIC', 'SPEI_SENTENCE_BOUNDARY',
    'SAFT32kHz8BitMono', 'DISPID_SRCEHypothesis', 'SPGS_DISABLED',
    'SpMMAudioOut', 'DISPID_SWFESamplesPerSec', 'SVP_11',
    'SAFT11kHz16BitStereo', 'DISPID_SpeechLexicon',
    'DISPID_SPIStartTime', 'DISPID_SVSVisemeId', 'SREPhraseStart',
    'SVEVoiceChange', 'DISPID_SVPriority', 'SAFT24kHz16BitMono',
    'DISPID_SLPsCount', 'DISPID_SBSFormat',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SAFType', 'SINoSignal',
    'SPEI_MAX_TTS', 'DISPID_SRIsShared', 'SpNullPhoneConverter',
    'DISPID_SpeechXMLRecoResult', 'SPDKL_DefaultLocation',
    'SAFT22kHz16BitStereo', 'DISPID_SOTGetStorageFileName', 'SRARoot',
    'SpeechAudioProperties', 'SAFT32kHz16BitMono', 'ISpRecoGrammar2',
    'ISpeechGrammarRuleState', 'SAFTGSM610_8kHzMono',
    'SVSFNLPSpeakPunc', 'SP_VISEME_0', 'DISPID_SRCCreateGrammar',
    'SPSHORTCUTPAIR', 'SAFTADPCM_11kHzMono',
    'SpeechCategoryRecoProfiles', 'DISPID_SGRSTNextState',
    'DISPID_SRAudioInput', 'SVPNormal', 'DISPID_SGRsCommitAndSave',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SRSActive',
    'DISPID_SRCESoundStart', 'SPINTERFERENCE_NOISE',
    'DISPID_SRCCmdMaxAlternates', 'eLEXTYPE_USER',
    'SAFT32kHz8BitStereo', 'DISPID_SVAudioOutput', 'SP_VISEME_12',
    'SGDSActiveUserDelimited', 'DISPID_SpeechWaveFormatEx',
    'SpeechRuleState', 'eLEXTYPE_MORPHOLOGY', 'SECNormalConfidence',
    'SVF_Stressed', 'DISPID_SOTCreateInstance',
    'DISPID_SOTIsUISupported', 'SP_VISEME_8',
    'DISPID_SOTCEnumerateTokens', 'SAFT44kHz8BitMono',
    'SAFT48kHz8BitStereo', 'DISPID_SBSRead', 'SDTAudio',
    'DISPID_SRRTimes', 'DISPID_SOTCSetId', 'SDA_No_Trailing_Space',
    'SVEPrivate', 'SECHighConfidence', 'DISPID_SRGId',
    'SpeechSpecialTransitionType', 'SVEEndInputStream',
    'ISpPhoneticAlphabetConverter', 'SRERecognition',
    'Speech_Default_Weight', 'ISpeechRecoResultTimes', 'SPPS_Noun',
    'SAFTADPCM_44kHzMono', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SPANumberOfElementsInResult', 'STCAll', 'SVF_None',
    'DISPID_SRRAudio', 'SpeechGrammarTagWildcard',
    'SPAO_RETAIN_AUDIO', 'DISPID_SREmulateRecognition',
    'DISPID_SFSOpen', 'SSFMCreateForWrite', 'ISpeechRecoResult',
    'SAFTADPCM_8kHzStereo', 'DISPID_SLAddPronunciation',
    'SPXRO_Alternates_SML', 'DISPID_SRRAlternates', 'DISPID_SLWType',
    'SVP_12', 'SPWT_PRONUNCIATION', 'SVEAllEvents',
    'SPSHORTCUTPAIRLIST', 'ISpPhraseAlt', 'SAFT24kHz16BitStereo',
    'SECFNoSpecialChars', 'DISPID_SpeechPhraseAlternates',
    'SpNotifyTranslator', 'DISPID_SRProfile', 'SPSHT_EMAIL',
    'SPSUnknown', 'DISPID_SMSGetData', 'SPRECORESULTTIMES',
    'SREFalseRecognition', 'SPEI_VOICE_CHANGE', 'DISPID_SAStatus',
    'eLEXTYPE_PRIVATE6', 'DISPID_SpeechLexiconWords',
    'DISPID_SRRSetTextFeedback', 'SVP_14',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SASState',
    'eWORDTYPE_DELETED', 'eWORDTYPE_ADDED',
    'DISPID_SVAudioOutputStream', 'SpeechEmulationCompareFlags',
    'SpeechRecoEvents', 'ISpeechPhraseElements', 'DISPID_SRCBookmark',
    ...
    'DISPID_SRRGetXMLResult', 'SPCT_COMMAND', 'SPGS_ENABLED',
    'DISPID_SABIMinNotification', 'SRCS_Enabled', 'SPEI_RECOGNITION',
    'Speech_StreamPos_Asap', 'SRTExtendableParse',
    'SPEI_FALSE_RECOGNITION', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SRRTLength', 'DISPID_SGRSAddSpecialTransition',
    'SPPS_Noncontent', 'SWPUnknownWordPronounceable', 'SRTStandard',
    'SASPause', 'DISPID_SRRPhraseInfo', 'ISpObjectWithToken',
    'DISPID_SPAsCount', 'SPEI_VISEME', 'DISPID_SpeechPhraseRules',
    'DISPID_SRCCreateResultFromMemory', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SRSClsidEngine', 'SPSSuppressWord',
    'SpeechCategoryPhoneConverters', 'SREStreamEnd', 'SP_VISEME_7',
    'ISpeechObjectToken', 'DISPIDSPTSI', 'SpeechDisplayAttributes',
    'ISpeechPhraseRule', 'DISPID_SGRSTPropertyId',
    'SPEI_TTS_AUDIO_LEVEL', 'eLEXTYPE_PRIVATE2',
    'SREPropertyNumChange', 'DISPID_SPEs_NewEnum',
    'ISpeechPhoneConverter', 'DISPID_SPISaveToMemory',
    'DISPID_SRCEEndStream', 'SRCS_Disabled', 'eLEXTYPE_USER_SHORTCUT',
    'SVP_0', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SRSetPropertyNumber', 'ISpResourceManager',
    'SpeechAudioState', 'DISPID_SpeechObjectToken',
    'eLEXTYPE_PRIVATE13', 'DISPID_SLGenerationId',
    'DISPID_SPIGrammarId', 'SpVoice', 'SDTReplacement',
    'DISPID_SLPType', 'DISPID_SPPFirstElement',
    'DISPID_SpeechAudioStatus', 'SPCT_SLEEP', 'SAFT16kHz16BitMono',
    'DISPIDSPRG', 'DISPID_SpeechLexiconWord', 'SPWF_INPUT',
    'DISPID_SRCEPropertyNumberChange', 'SDA_Consume_Leading_Spaces',
    'SPPS_SuppressWord', 'DISPID_SPRuleChildren',
    'SDA_One_Trailing_Space', 'SPFILEMODE', 'eLEXTYPE_RESERVED9',
    'DISPID_SRCEEnginePrivate', 'SPPS_Verb', 'DISPID_SLWsCount',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPPS_RESERVED3',
    'SRAImport', 'SPRST_ACTIVE', 'DISPID_SVSpeak',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SpeechPhraseElements',
    'SPSHT_Unknown', 'DISPID_SVStatus', 'STCRemoteServer',
    'eLEXTYPE_LETTERTOSOUND', 'SPEVENTENUM', 'SAFTNonStandardFormat',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SpeechFileStream',
    'SpeechUserTraining', 'DISPID_SOTCId', 'SPSHORTCUTTYPE',
    'ISpeechLexiconPronunciation', 'DISPID_SGRAttributes',
    'DISPID_SMSAMMHandle', 'SPGRAMMARSTATE', 'SpeechGrammarState',
    'SGDisplay', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SpeechTokenKeyAttributes', 'DISPID_SOTId',
    'DISPID_SpeechRecoResultTimes', 'SP_VISEME_21', 'DISPID_SGRsItem',
    'DISPID_SVGetProfiles', 'SECFIgnoreCase', 'SPSHT_OTHER',
    'SVEBookmark', 'SVP_8', 'SAFT8kHz16BitMono',
    'SAFT16kHz8BitStereo', 'SPPS_Unknown', 'ISpeechResourceLoader',
    'DISPID_SPERequiredConfidence', 'ISpNotifySource',
    'DISPID_SVSRunningState', 'SPWT_DISPLAY', 'SPEI_RESERVED3',
    'IStream', 'ISpeechXMLRecoResult',
    'DISPID_SLAddPronunciationByPhoneIds', 'SPBINARYGRAMMAR',
    'DISPID_SOTGetDescription', 'SpeechCategoryVoices',
    'DISPID_SRCEInterference', 'SP_VISEME_2', 'SPWORD',
    'SDKLCurrentUser', 'DISPID_SGRSTPropertyValue', 'SVSFParseMask',
    'STSF_LocalAppData', 'SRESoundEnd', 'SPRS_INACTIVE',
    'SpeechCategoryAudioIn', 'DISPID_SDKOpenKey', 'SGSDisabled',
    'SPPS_Interjection', 'SITooLoud', 'DISPID_SGRSTPropertyName',
    'DISPID_SVIsUISupported', 'SpeechGrammarTagDictation',
    'SWTDeleted', 'SpShortcut', 'ISpeechBaseStream', 'SGRSTTEpsilon',
    'eLEXTYPE_PRIVATE9', 'DISPID_SVPause', 'DISPID_SRCEStartStream',
    'ISpEventSource', 'SPAR_Unknown', 'ISpStream',
    'DISPID_SPRDisplayAttributes', 'ISpeechMMSysAudio',
    'DISPID_SPEEngineConfidence', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SDKGetlongValue', 'SAFT22kHz16BitMono',
    'eLEXTYPE_PRIVATE17', 'SPEI_ADAPTATION', 'SGDSInactive',
    'ISpeechPhraseReplacement', 'eLEXTYPE_RESERVED10',
    'DISPID_SLWsItem', 'SpWaveFormatEx', 'SVSFVoiceMask',
    'DISPID_SpeechPhraseBuilder', 'SPEI_HYPOTHESIS', 'SVP_9',
    'DISPID_SRState', 'SVSFParseSapi', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SAFSetWaveFormatEx', 'SPEI_START_SR_STREAM',
    'SSTTDictation', 'DISPID_SpeechCustomStream',
    'SpeechPropertyHighConfidenceThreshold', 'SPEI_RESERVED6',
    'DISPID_SGRsFindRule', 'DISPID_SpeechRecoContextEvents', 'SVP_5',
    'SPGS_EXCLUSIVE', 'DISPID_SRSSupportedLanguages',
    'SAFT48kHz8BitMono', 'DISPID_SPPId', 'eLEXTYPE_PRIVATE14',
    'DISPID_SGRClear', 'SRTAutopause', 'SpeechDiscardType',
    'SAFTDefault', 'DISPID_SPRuleFirstElement', 'tagSTATSTG',
    'DISPID_SPACommit', 'SPFM_OPEN_READWRITE', 'DISPID_SASetState',
    'SPEI_MIN_TTS', 'SRADynamic', 'DISPID_SPEDisplayText', 'UINT_PTR',
    'SPAS_PAUSE', 'DISPID_SpeechRecoResult2', 'SPSNotOverriden',
    'DISPID_SRCEAdaptation', 'eLEXTYPE_PRIVATE4', 'SECFIgnoreWidth',
    'DISPID_SpeechPhraseProperty', 'SREHypothesis', 'SVEViseme',
    'DISPID_SpeechLexiconProns', 'DISPID_SRGCmdLoadFromResource',
    'SGRSTTTextBuffer', 'DISPID_SRRTStreamTime',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SPEsCount',
    'DISPID_SVSpeakStream', 'SVSFUnusedFlags', 'DISPID_SAEventHandle',
    'SVEWordBoundary', 'DISPID_SRGRecoContext', 'SpeechAddRemoveWord',
    'ISpeechLexicon', 'SP_VISEME_9', 'DISPID_SLGetPronunciations',
    'LONG_PTR', 'DISPID_SRCAudioInInterferenceStatus',
    'eLEXTYPE_PRIVATE3', 'ISpObjectToken',
    'SpeechPropertyResponseSpeed', 'SPFM_CREATE', 'SP_VISEME_1',
    'SpeechRecognizerState', 'SPAR_High', 'DISPID_SGRAddState',
    'SpeechPropertyResourceUsage', 'SAFTCCITT_ALaw_11kHzStereo',
    'ISpeechMemoryStream', 'DISPID_SPEAudioTimeOffset', 'SPAR_Medium',
    'SPEI_TTS_BOOKMARK', 'DISPID_SRGetPropertyString',
    'ISpRecoCategory', 'ISpVoice', 'DISPID_SGRSTRule',
    'SGDSActiveWithAutoPause', 'SpStream', 'DISPID_SAFGuid', 'SVP_7',
    'eLEXTYPE_RESERVED4', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SRGDictationUnload', 'SPINTERFERENCE_TOOFAST',
    'ISpeechFileStream', 'SpeechWordType',
    'DISPID_SVSInputWordPosition', 'SP_VISEME_15', 'SECFDefault',
    'DISPID_SASFreeBufferSpace', 'SITooSlow', 'DISPID_SPCIdToPhone',
    'SPBO_AHEAD', 'SPEI_PHONEME', 'DISPID_SRCEventInterests',
    'ISpeechObjectTokens', 'SpUnCompressedLexicon', 'SPVISEMES',
    'SVSFPurgeBeforeSpeak', 'SpeechVoiceSpeakFlags',
    'DISPID_SVSLastBookmark', 'SPFM_OPEN_READONLY',
    'ISpPhoneConverter', 'ISpXMLRecoResult', 'SPPHRASEPROPERTY',
    'SVP_2', 'DISPID_SPRuleConfidence', 'DISPID_SFSClose',
    'DISPID_SVRate', 'SDA_Two_Trailing_Spaces',
    'DISPID_SRGIsPronounceable', 'SPBO_PAUSE',
    'IInternetSecurityManager', 'DISPID_SRCResume', 'SREAdaptation',
    'ISpeechVoiceStatus', 'SAFT12kHz16BitStereo', 'SSTTWildcard',
    'SAFTCCITT_ALaw_11kHzMono', 'SRATopLevel',
    'DISPID_SDKSetStringValue', 'SRERequestUI',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SPPs_NewEnum',
    'DISPID_SpeechPhoneConverter', 'DISPID_SLPs_NewEnum',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPDKL_CurrentConfig',
    'DISPID_SDKSetLongValue', 'DISPID_SRGDictationLoad',
    'eLEXTYPE_PRIVATE20', 'SpPhraseInfoBuilder',
    'DISPID_SPCPhoneToId', 'SAFTADPCM_11kHzStereo',
    'DISPID_SWFEBitsPerSample', 'DISPID_SRSetPropertyString',
    'SpeechMicTraining', 'SRAONone', 'SPSTREAMFORMATTYPE',
    'SPEI_UNDEFINED', 'DISPID_SRSNumberOfActiveRules',
    'SpeechAllElements', 'SAFT22kHz8BitStereo',
    'DISPID_SWFEBlockAlign', '_ISpeechVoiceEvents',
    'SRSInactiveWithPurge', 'SVEStartInputStream', 'SpeechTokenKeyUI',
    'SPRULE', 'DISPID_SPRFirstElement', 'SAFT16kHz8BitMono',
    'SGSEnabled', 'SLTUser', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SVSFParseAutodetect', 'DISPID_SLPLangId',
    'DISPID_SpeechPhraseReplacement', 'SAFTADPCM_22kHzMono',
    'SSTTTextBuffer', 'SVSFIsXML', 'SpeechLoadOption',
    'DISPID_SPPValue', 'DISPID_SRGState', 'DISPID_SGRSTText',
    'DISPID_SPPEngineConfidence', 'SPXMLRESULTOPTIONS',
    'DISPID_SMSADeviceId', 'SpeechLexiconType', 'SFTInput',
    'SpCustomStream', 'DISPID_SVVolume', 'SRAExport',
    'DISPID_SRGReset', 'DISPID_SRCSetAdaptationData',
    'SDKLCurrentConfig', 'DISPIDSPTSI_SelectionOffset',
    'SVSFlagsAsync', 'DISPID_SPPParent', 'SPRST_INACTIVE_WITH_PURGE',
    'SPVPRI_NORMAL', 'SPAO_NONE', 'ISpeechPhraseRules',
    'DISPID_SRGSetWordSequenceData', 'SPPHRASEELEMENT',
    'DISPID_SGRSTs_NewEnum', 'SPEI_MAX_SR',
    'DISPID_SpeechMemoryStream', 'DISPID_SRCERecognition',
    'DISPIDSPTSI_ActiveOffset', 'SVP_3', 'SPPS_RESERVED1',
    'SAFT8kHz8BitMono', 'DISPID_SRRAudioFormat',
    'SpeechVisemeFeature', 'SGSExclusive', 'SPEI_REQUEST_UI',
    'DISPID_SPRules_NewEnum', 'SWTAdded', 'SDTDisplayText',
    'DISPID_SRRecognizer', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPWT_LEXICAL',
    'eLEXTYPE_PRIVATE18', 'DISPID_SBSWrite',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SRCEFalseRecognition',
    'SP_VISEME_14', 'SPEI_WORD_BOUNDARY', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SRSAudioStatus', 'eLEXTYPE_PRIVATE19',
    ...
    'DISPID_SDKSetBinaryValue', 'SPWF_SRENGINE',
    'SAFTCCITT_uLaw_11kHzMono', 'ISpRecoResult',
    'SPTEXTSELECTIONINFO', 'SVP_16', 'DISPID_SpeechAudioFormat',
    'SAFT16kHz16BitStereo', 'SPRST_NUM_STATES', 'SVP_15',
    'DISPID_SVSCurrentStreamNumber', 'ISpeechRecognizer',
    'DISPID_SPPsItem', 'SINone', 'Speech_Max_Pron_Length',
    'SPRS_ACTIVE', 'SVP_20', 'DISPID_SOTRemove', 'SITooFast',
    'DISPID_SDKDeleteValue', 'SPSEMANTICFORMAT', 'SVP_19',
    'DISPID_SPRText', 'DISPID_SPPsCount', 'DISPID_SDKGetBinaryValue',
    'Speech_StreamPos_RealTime', 'SPCT_SUB_COMMAND', 'SINoise',
    'SpeechTokenContext', 'SAFT12kHz8BitStereo',
    'SpeechAudioFormatType', 'SPEI_SR_PRIVATE',
    'DISPID_SVSInputWordLength', 'SPEI_MIN_SR',
    'DISPID_SpeechGrammarRuleState', 'SPEVENT', 'DISPID_SVVoice',
    'ISpShortcut', 'SPEI_SR_BOOKMARK', 'Speech_Max_Word_Length',
    'DISPID_SGRSTType', 'DISPID_SGRName', 'SDTLexicalForm',
    'SPPHRASE', 'DISPID_SVEEnginePrivate',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SRTReSent', 'SASStop',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SpeechVoice',
    'SPEI_TTS_PRIVATE', 'SVSFNLPMask', 'SAFT8kHz8BitStereo',
    'DISPID_SVEStreamStart', 'SAFT22kHz8BitMono',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', '_RemotableHandle',
    'DISPID_SRCreateRecoContext', 'SRAInterpreter', 'SPLOADOPTIONS',
    'SPEI_START_INPUT_STREAM', 'DISPID_SPELexicalForm', 'SPSFunction',
    'DISPID_SpeechVoiceEvent', 'SpeechCategoryRecognizers',
    'DISPID_SMSALineId', 'DISPID_SRRTTickCount',
    'SpeechPropertyNormalConfidenceThreshold',
    'SAFTADPCM_44kHzStereo', 'SITooQuiet', 'SPRECOGNIZERSTATUS',
    'SPWORDTYPE', 'ISpEventSink', 'DISPIDSPTSI_SelectionLength',
    'SPAUDIOBUFFERINFO', 'SPEI_END_INPUT_STREAM',
    'DISPID_SGRs_NewEnum', 'DISPID_SpeechObjectTokens',
    'SAFT24kHz8BitStereo', 'SP_VISEME_11', 'SPFM_NUM_MODES',
    'SDKLLocalMachine', 'SPBOOKMARKOPTIONS', 'SREInterference',
    'DISPID_SGRInitialState', 'SAFT12kHz8BitMono',
    'SpResourceManager', 'eLEXTYPE_PRIVATE11', 'SREAllEvents',
    'DISPID_SpeechPhraseProperties', '__MIDL_IWinTypes_0009',
    'DISPID_SOTDataKey', 'SPVPRI_OVER', 'DISPID_SRStatus',
    'SAFT44kHz16BitMono', 'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SRCRecognizer', 'SVP_6', 'SVSFPersistXML',
    'SpeechEngineConfidence', 'ISpAudio', 'SPINTERFERENCE',
    'DISPID_SRIsUISupported', 'SAFTCCITT_ALaw_22kHzMono',
    'SpeechRegistryUserRoot', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SLWPronunciations', 'DISPID_SAVolume', 'SPEI_SOUND_START',
    'DISPID_SOTDisplayUI', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SGRSTWeight',
    'SRAORetainAudio', 'DISPID_SRSCurrentStreamNumber', 'SPBO_NONE',
    'SVP_1', 'SAFT11kHz16BitMono', 'ISpSerializeState',
    'SpeechTokenKeyFiles', 'SREAudioLevel', 'DISPID_SLWWord',
    'SAFT32kHz16BitStereo', 'SPCS_ENABLED',
    'DISPID_SPAStartElementInResult', 'SP_VISEME_10',
    'DISPID_SRRSpeakAudio', 'DISPID_SRCERecognizerStateChange',
    'SpeechRunState', 'SLOStatic', 'SBOPause', '_SPAUDIOSTATE',
    'SPCONTEXTSTATE', 'SAFT48kHz16BitMono', 'ISpeechAudioBufferInfo',
    'DISPID_SGRSRule', 'SVESentenceBoundary',
    'SpeechTokenShellFolder', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SRGetFormat', 'ISpeechRecognizerStatus',
    'DISPID_SABIBufferSize', 'STCInprocHandler',
    'SpPhoneticAlphabetConverter', 'DISPID_SVEAudioLevel',
    'SVEPhoneme', 'DISPID_SPEAudioSizeBytes',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SOTsItem', 'ISpRecognizer3',
    'DISPID_SRGetPropertyNumber', 'SP_VISEME_16', 'STCLocalServer',
    'SPCT_DICTATION', 'SPAUDIOSTATUS', 'ISpRecognizer',
    'STSF_CommonAppData', 'SVP_10', 'DISPID_SPIGetText',
    'DISPID_SGRSTsCount', 'SpAudioFormat', 'SPVPRIORITY',
    'SRSInactive', 'SAFTGSM610_44kHzMono', 'SPEI_SR_AUDIO_LEVEL',
    'SP_VISEME_17', 'SREStreamStart', 'STCInprocServer',
    'SPPHRASERULE', 'DISPID_SLPPartOfSpeech',
    'SAFTExtendedAudioFormat', 'DISPID_SPRuleEngineConfidence',
    'SpeechDictationTopicSpelling', 'SSFMCreate', 'SPWAVEFORMATTYPE',
    'SpeechVoiceEvents', 'DISPID_SVSInputSentenceLength',
    'DISPID_SPEPronunciation', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SPRulesCount', 'DISPID_SpeechGrammarRule',
    'SpeechBookmarkOptions', 'SpeechCategoryAudioOut',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SDKEnumKeys',
    'DISPID_SAFGetWaveFormatEx', 'ISpStreamFormatConverter',
    'DISPID_SGRSTsItem', 'SRTSMLTimeout', 'SpeechAudioFormatGUIDText',
    'SRADefaultToActive', 'SPEI_END_SR_STREAM',
    'DISPID_SRAudioInputStream', 'SPSVerb', 'DISPID_SpeechBaseStream',
    'SpeechGrammarWordType', 'SPCS_DISABLED', 'SPEI_SR_RETAINEDAUDIO',
    'SWPUnknownWordUnpronounceable', 'SpeechEngineProperties',
    'DISPID_SRCEPhraseStart', 'eLEXTYPE_PRIVATE16',
    'DISPID_SPERetainedSizeBytes', 'SpeechRuleAttributes',
    'tagSPTEXTSELECTIONINFO', 'SPPS_Function', 'DISPID_SABufferInfo',
    'SPCT_SUB_DICTATION', 'eLEXTYPE_APP'
]
